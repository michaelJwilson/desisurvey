...
def X0(airmass):  
  ...
  return  -0.01219933 + 0.15637074 * airmass ** 0.75

def X1(airmass):
  ##  v1:         return  -7.68546710e-06 + 5.75539255e-05 * airmass ** 0.75
  ##  v3 (4000):  

  return  -6.94106378e-06 + 5.83134727e-05 * airmass ** 0.75
...
def Z0(moonalt, moonfrac, airmass):
  ...
  result =  1. + _Y0 * np.log(moonalt / 0.6)
